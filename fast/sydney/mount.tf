...
resource "aws_instance" "ap_southeast_2a_gateway" {
...
resource "aws_network_interface" "ap_southeast_2a_database" {
  subnet_id = aws_subnet.ap_southeast_2a_gateway.id
}

resource "aws_eip" "ap_southeast_2a_database" {
  vpc = true
  network_interface = aws_network_interface.ap_southeast_2a_database.id
...
resource "aws_instance" "ap_southeast_2a_database" {
  ami = "ami-0c55b159cbfafe1f0"
  instance_type = "t1.micro"
  availability_zone = "ap-southeast-2a"
  vpc_security_group_ids = [
...
resource "aws_ebs_volume" "ap_southeast_2a_database" {
  availability_zone = "ap-southeast-2a"
  size = 40
...
resource "aws_volume_attachment" "ap_southeast_2a_database" {
  device_name = "/dev/sdh"
  volume_id = aws_ebs_volume.ap_southeast_2a_database.id
  instance_id = aws_instance.ap_southeast_2a_database.id
}
...
resource "aws_instance" "ap_southeast_2b_gateway" {
  ami = "ami-0c55b159cbfafe1f0"
  instance_type = "t1.micro"
...
resource "aws_network_interface" "ap_southeast_2b_database" {
  subnet_id = aws_subnet.ap_southeast_2b_gateway.id
}

resource "aws_eip" "ap_southeast_2b_database" {
  vpc = true
  network_interface = aws_network_interface.ap_southeast_2b_database.id
...
resource "aws_instance" "ap_southeast_2b_database" {
  ami = "ami-0c55b159cbfafe1f0"
  instance_type = "t1.micro"
  availability_zone = "ap-southeast-2b"
  vpc_security_group_ids = [
...
resource "aws_ebs_volume" "ap_southeast_2b_database" {
  availability_zone = "ap-southeast-2b"
  size = 40
...
resource "aws_volume_attachment" "ap_southeast_2b_database" {
  device_name = "/dev/sdh"
  volume_id = aws_ebs_volume.ap_southeast_2b_database.id
  instance_id = aws_instance.ap_southeast_2b_database.id
}
...
resource "aws_instance" "ap_southeast_2c_gateway" {
  ami = "ami-0c55b159cbfafe1f0"
  instance_type = "t1.micro"
...
resource "aws_network_interface" "ap_southeast_2c_database" {
  subnet_id = aws_subnet.ap_southeast_2c_gateway.id
}

resource "aws_eip" "ap_southeast_2c_database" {
  vpc = true
  network_interface = aws_network_interface.ap_southeast_2c_database.id
...
resource "aws_instance" "ap_southeast_2c_database" {
  ami = "ami-0c55b159cbfafe1f0"
  instance_type = "t1.micro"
  availability_zone = "ap-southeast-2c"
  vpc_security_group_ids = [
...
resource "aws_ebs_volume" "ap_southeast_2c_database" {
  availability_zone = "ap-southeast-2c"
  size = 40
...
resource "aws_volume_attachment" "ap_southeast_2c_database" {
  device_name = "/dev/sdh"
  volume_id = aws_ebs_volume.ap_southeast_2c_database.id
  instance_id = aws_instance.ap_southeast_2c_database.id
}
